...
export const deleteSaleOrderItem: RequestHandler = async(req, res, _next) =>{
    ...
    return res.status(200).json({message: "Sale Order Item deleted successfully", data:deletedItem})
}
...
export const getAllSaleOrderItem: RequestHandler = async(_req, res, _next) => {
    ...
    return res.status(200).json({message: "Sale Order Item fetched successfully", data: allItems});
}
...
export const getSaleOrderItemById: RequestHandler = async(req, res, _next) => {
    ...
    return res.status(200).json({message:"Sale Order Item fetched successfully", data: item});
}
...
export const updateSaleOrderItem: RequestHandler = async(req, res, _next) => {
    ...
    return res.status(200).json({message:"Sale Order Item updated successfully", data: updatedItem})
}
